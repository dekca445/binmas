{{-- 
    =======================================================
    FILE: subditbhabinkamtibmas.blade.php
    =======================================================
--}}
@php
    // 1. DATA SPESIFIK SUBDIT BHABINKAMTIBMAS
    $data = [
        'nama_satker' => 'SUBDIT BHABINKAMTIBMAS', 
        'deskripsi'   => 'Subdirektorat Bhabinkamtibmas bertugas membina dan mengawasi operasional petugas Bhabinkamtibmas di tingkat desa/kelurahan, serta melakukan revitalisasi Pos Kamling (Satkamling) untuk menciptakan keamanan lingkungan.',
        
        // PIMPINAN
        'pimpinan_foto'   => 'https://ui-avatars.com/api/?name=Kasubdit+Bhabin&background=2563EB&color=fff&size=200',
        'pimpinan_nama'   => 'AKBP LALU MUHAMMAD, S.I.K.',
        'pimpinan_jabatan'=> 'Kasubdit Bhabinkamtibmas',
        'pimpinan_pangkat'=> 'Ajun Komisaris Besar Polisi',

        // TUGAS POKOK
        'tugas_pokok' => 'Menyelenggarakan pembinaan teknis, kemampuan, dan manajemen operasional Bhabinkamtibmas serta pembinaan partisipasi masyarakat melalui Poskamling.',

        // FUNGSI
        'fungsi' => [
            'Asistensi dan supervisi kinerja Bhabinkamtibmas di kewilayahan.',
            'Peningkatan kemampuan petugas Polmas desa/kelurahan.',
            'Revitalisasi dan pembinaan awak Pos Kamling (Satkamling).',
            'Analisa dan evaluasi data pelaporan aplikasi BOS V2.'
        ],

        // STRUKTUR ORGANISASI
        'struktur' => [
            'root' => 'KASUBDIT BHABIN',
            'level_1' => ['SIE OPSNAL', 'SIE ANEV', 'SIE LATPUAN']
        ]
    ];

    // 2. DATA ANGGOTA BHABIN
    $anggota = [
        (object)['nama' => 'Kompol I Wayan', 'pangkat' => 'Kompol', 'jabatan' => 'Kasi Opsnal', 'foto' => null],
        (object)['nama' => 'AKP Siti Aminah', 'pangkat' => 'AKP', 'jabatan' => 'Kasi Anev', 'foto' => null],
        (object)['nama' => 'Iptu Burhan', 'pangkat' => 'Iptu', 'jabatan' => 'Kasi Latpuan', 'foto' => null],
        (object)['nama' => 'Ipda Zulkarnain', 'pangkat' => 'Ipda', 'jabatan' => 'Pamin', 'foto' => null],
        (object)['nama' => 'Aiptu Saleh', 'pangkat' => 'Aiptu', 'jabatan' => 'Banum', 'foto' => null],
        (object)['nama' => 'Bripka Dedi', 'pangkat' => 'Bripka', 'jabatan' => 'Operator BOS', 'foto' => null],
    ];
@endphp
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-8 fade-in-up items-start">
    ...
    <div class="lg:col-span-8 space-y-10">
        ...
        {{-- 4. FITUR KHUSUS BHABIN (Bhabin Teladan & Poskamling) --}}
        <div class="bg-gradient-to-br from-blue-50 to-white rounded-2xl shadow-lg p-8 border border-blue-100">
            <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                <span class="material-icons text-blue-600 mr-2">local_police</span> Bhabin & Poskamling
            </h3>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                {{-- Profil Bhabin Teladan --}}
                <div class="bg-white rounded-xl p-0 border border-blue-200 shadow-sm overflow-hidden flex flex-col">
                    <div class="bg-blue-600 px-4 py-2 flex justify-between items-center">
                        <span class="text-xs font-bold text-white uppercase tracking-wider">Bhabin of The Month</span>
                        <span class="material-icons text-white text-sm">stars</span>
                    </div>
                    <div class="p-6 flex flex-col items-center text-center">
                        <div class="w-20 h-20 rounded-full border-4 border-blue-100 mb-3 overflow-hidden">
                            <img src="https://ui-avatars.com/api/?name=Aipda+Soleh&background=random" class="w-full h-full object-cover">
                        </div>
                        <h4 class="font-bold text-gray-800">Aipda Solehudin</h4>
                        <p class="text-xs text-blue-600 font-bold uppercase mb-2">Polres Lombok Tengah</p>
                        <p class="text-xs text-gray-500 italic">"Inovator Desa Wisata Aman & Penggerak 15 Poskamling Aktif."</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="bg-yellow-50 rounded-xl p-4 border border-yellow-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h5 class="font-bold text-gray-800 text-lg">1,240</h5>
                                <p class="text-xs text-gray-600">Poskamling Aktif se-NTB</p>
                            </div>
                        </div>
                    </div>

                    {{-- Cari Bhabin --}}
                    <div class="bg-white p-4 rounded-xl border border-gray-200 flex-1 flex flex-col justify-center">
                        <h5 class="font-bold text-gray-800 text-sm mb-2">Cari Bhabin Desa Anda</h5>
                        <div class="flex gap-2">
                            <input type="text" placeholder="Nama Desa/Kelurahan..." class="w-full border rounded-lg px-3 py-2 text-sm">
                            <button class="bg-primary text-white px-3 py-2 rounded-lg text-sm hover:bg-blue-700">
            ...
            <div class="space-y-3">
                <details class="group bg-gray-50 rounded-lg overflow-hidden">
                    <summary class="flex justify-between items-center font-medium cursor-pointer list-none p-4 hover:bg-gray-100 transition">
                        <span class="text-sm text-gray-700 font-bold">Bagaimana menghubungi Bhabinkamtibmas?</span>
                    ...
                    <div class="text-gray-600 text-sm p-4 border-t border-gray-100 bg-white">
                        Nomor kontak Bhabinkamtibmas biasanya ditempel di Kantor Desa/Lurah atau Poskamling. Anda juga bisa mencari via fitur di atas.
                    </div>
                </details>
                <details class="group bg-gray-50 rounded-lg overflow-hidden">
                    <summary class="flex justify-between items-center font-medium cursor-pointer list-none p-4 hover:bg-gray-100 transition">
                        <span class="text-sm text-gray-700 font-bold">Apa syarat mendirikan Poskamling?</span>
                        <span class="transition group-open:rotate-180 material-icons text-gray-400 text-sm">expand_more</span>
                    </summary>
                    <div class="text-gray-600 text-sm p-4 border-t border-gray-100 bg-white">
                        Kesepakatan warga setempat, tersedia lokasi/bangunan pos, struktur awak poskamling, dan peralatan dasar (senter, kentongan, dll).
                    </div>
                </details>
            </div>
        </div>
    ...
    <div class="lg:col-span-4 space-y-8 sticky top-24">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-3 gap-2 mb-4">
                <img src="https://source.unsplash.com/200x200/?village,police" class="rounded-lg object-cover w-full h-16 hover:opacity-80 transition cursor-pointer">
                ...
                <div class="rounded-lg bg-gray-100 flex items-center justify-center h-16 cursor-pointer hover:bg-gray-200 text-xs font-bold text-gray-500">+12</div>
            </div>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-3">
                <div class="flex gap-3 items-center">
                    ...
                    <div>
                        <p class="text-xs font-bold text-gray-800 line-clamp-1">Lomba Poskamling</p>
                        <p class="text-[10px] text-gray-500">Tingkat Polda NTB</p>
                    </div>
                </div>
            </div>
        </div>

        {{-- 3. Area Download / Regulasi (Bhabin) --}}
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
            ...
            <ul class="space-y-2">
                <li class="flex items-center justify-between p-2 hover:bg-gray-50 rounded cursor-pointer group">
                    <div class="flex items-center overflow-hidden">
                        <span class="material-icons text-gray-300 text-sm mr-2 group-hover:text-red-500">menu_book</span>
                        <span class="text-xs text-gray-600 truncate font-medium">Buku Saku Bhabinkamtibmas</span>
                    </div>
                ...
                <li class="flex items-center justify-between p-2 hover:bg-gray-50 rounded cursor-pointer group">
                    <div class="flex items-center overflow-hidden">
                        ...
                        <span class="text-xs text-gray-600 truncate font-medium">Jukrah Revitalisasi Poskamling</span>
                    </div>

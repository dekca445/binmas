{{-- 
    =======================================================
    FILE: subditbinsatpam.blade.php
    =======================================================
--}}
@php
    // 1. DATA SPESIFIK SUBDIT BINSATPAM/POLSUS
    $data = [
        'nama_satker' => 'SUBDIT BINSATPAM/POLSUS', 
        'deskripsi'   => 'Subdirektorat Pembinaan Satpam dan Polisi Khusus bertugas membina, mengawasi, dan melatih pengamanan swakarsa (Satpam) serta melakukan koordinasi, pengawasan, dan pembinaan teknis terhadap Kepolisian Khusus (Polsus).',
        
        // PIMPINAN
        'pimpinan_foto'   => 'https://ui-avatars.com/api/?name=Kasubdit+Satpam&background=EA580C&color=fff&size=200',
        'pimpinan_nama'   => 'AKBP HENDRA GUNAWAN, S.I.K.',
        'pimpinan_jabatan'=> 'Kasubdit Binsatpam/Polsus',
        'pimpinan_pangkat'=> 'Ajun Komisaris Besar Polisi',

        // TUGAS POKOK
        'tugas_pokok' => 'Melaksanakan registrasi, sertifikasi, dan pengawasan operasional Badan Usaha Jasa Pengamanan (BUJP) serta menyelenggarakan pembinaan kemampuan teknis Satpam dan Polsus.',

        // FUNGSI
        'fungsi' => [
            'Pembinaan dan pelatihan kemampuan (Diklat) Satpam & Polsus (Gada Pratama/Madya/Utama).',
            'Pengawasan dan penertiban seragam serta atribut (Gampol) Pam Swakarsa.',
            'Audit sistem manajemen pengamanan (SMP) pada Obvitnas/Tertentu.',
            'Pelayanan administrasi KTA Satpam dan rekomendasi operasional BUJP.'
        ],

        // STRUKTUR ORGANISASI
        'struktur' => [
            'root' => 'KASUBDIT BINSATPAM',
            'level_1' => ['SIE BINLAT', 'SIE WASJASPAM', 'SIE KORWAS']
        ]
    ];

    // 2. DATA ANGGOTA SATPAM/POLSUS
    $anggota = [
        (object)['nama' => 'Kompol Budiarto', 'pangkat' => 'Kompol', 'jabatan' => 'Kasi Binlat', 'foto' => null],
        (object)['nama' => 'AKP Rina Susanti', 'pangkat' => 'AKP', 'jabatan' => 'Kasi Wasjaspam', 'foto' => null],
        (object)['nama' => 'Iptu Gunawan', 'pangkat' => 'Iptu', 'jabatan' => 'Kasi Korwas', 'foto' => null],
        (object)['nama' => 'Ipda Haryanto', 'pangkat' => 'Ipda', 'jabatan' => 'Paur Min', 'foto' => null],
        (object)['nama' => 'Aiptu Junaedi', 'pangkat' => 'Aiptu', 'jabatan' => 'Banum KTA', 'foto' => null],
        (object)['nama' => 'Bripka Santosa', 'pangkat' => 'Bripka', 'jabatan' => 'Banum BUJP', 'foto' => null],
    ];
@endphp
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-8 fade-in-up items-start">
    ...
    <div class="lg:col-span-8 space-y-10">
        ...
        {{-- 4. FITUR KHUSUS BINSATPAM (Jadwal Diklat & Legalitas BUJP) --}}
        <div class="bg-gradient-to-br from-orange-50 to-white rounded-2xl shadow-lg p-8 border border-orange-100">
            <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                <span class="material-icons text-orange-500 mr-2">verified_user</span> Layanan Satpam & BUJP
            </h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-orange-50 rounded-xl p-6 border border-orange-100">
                    <h4 class="font-bold text-gray-800 mb-3">Jadwal Diklat Gada Pratama/Madya</h4>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left">
                            ...
                            <tbody class="bg-white">
                                <tr class="border-b">
                                    <td class="px-3 py-2">Gada Pratama</td>
                                    <td class="px-3 py-2">10 - 24 Nov</td>
                                    <td class="px-3 py-2">PT. Garda NTB</td>
                                </tr>
                                <tr class="border-b">
                                    <td class="px-3 py-2">Gada Madya</td>
                                    <td class="px-3 py-2">01 - 14 Des</td>
                                    <td class="px-3 py-2">PT. Sentosa Sec</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <button class="mt-4 text-xs font-bold text-orange-600 hover:underline">Lihat Jadwal Lengkap →</button>
                </div>
                
                {{-- Cek Legalitas --}}
                <div class="bg-white rounded-xl p-6 border border-gray-200 shadow-sm flex flex-col justify-center text-center">
                    <span class="material-icons text-4xl text-gray-400 mb-2">domain_verification</span>
                    <h4 class="font-bold text-gray-800">Cek Legalitas BUJP</h4>
                    <p class="text-sm text-gray-500 mb-4">Pastikan Badan Usaha Jasa Pengamanan (PT) terdaftar resmi dan memiliki izin operasional aktif.</p>
                    <div class="flex gap-2">
                        <input type="text" placeholder="Masukkan Nama PT..." class="w-full border rounded-lg px-3 py-2 text-sm">
            ...
            <div class="space-y-3">
                <details class="group bg-gray-50 rounded-lg overflow-hidden">
                    <summary class="flex justify-between items-center font-medium cursor-pointer list-none p-4 hover:bg-gray-100 transition">
                        <span class="text-sm text-gray-700 font-bold">Berapa biaya pembuatan KTA Satpam Baru?</span>
                    ...
                    <div class="text-gray-600 text-sm p-4 border-t border-gray-100 bg-white">
                        Biaya pembuatan KTA Satpam sesuai dengan PP No. 76 Tahun 2020 tentang PNBP (Penerimaan Negara Bukan Pajak).
                    </div>
                </details>
                <details class="group bg-gray-50 rounded-lg overflow-hidden">
                    <summary class="flex justify-between items-center font-medium cursor-pointer list-none p-4 hover:bg-gray-100 transition">
                        <span class="text-sm text-gray-700 font-bold">Apa persyaratan mengikuti Gada Pratama?</span>
                        <span class="transition group-open:rotate-180 material-icons text-gray-400 text-sm">expand_more</span>
                    </summary>
                    <div class="text-gray-600 text-sm p-4 border-t border-gray-100 bg-white">
                        WNI, Lulusan minimal SMA/Sederajat, Tinggi badan min 165cm (Pria) / 160cm (Wanita), Surat Keterangan Sehat & Bebas Narkoba.
                    </div>
                </details>
            </div>
        </div>
    ...
    <div class="lg:col-span-4 space-y-8 sticky top-24">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-3 gap-2 mb-4">
                <img src="https://source.unsplash.com/200x200/?security,guard" class="rounded-lg object-cover w-full h-16 hover:opacity-80 transition cursor-pointer">
                <img src="https://source.unsplash.com/200x200/?training,police" class="rounded-lg object-cover w-full h-16 hover:opacity-80 transition cursor-pointer">
                <div class="rounded-lg bg-gray-100 flex items-center justify-center h-16 cursor-pointer hover:bg-gray-200 text-xs font-bold text-gray-500">+10</div>
            </div>
            
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-3">
                <div class="flex gap-3 items-center">
                    <div class="bg-white border border-gray-200 rounded p-1 text-center min-w-[40px]">
                        <span class="block text-[10px] font-bold text-red-500">JAN</span>
                        <span class="block text-lg font-bold text-gray-800">12</span>
                    </div>
                    <div>
                        <p class="text-xs font-bold text-gray-800 line-clamp-1">Upacara HUT Satpam</p>
                        <p class="text-[10px] text-gray-500">Lapangan Polda NTB</p>
                    </div>
                </div>
            </div>
        </div>

        {{-- 3. Area Download / Regulasi (Satpam) --}}
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
            ...
            <ul class="space-y-2">
                <li class="flex items-center justify-between p-2 hover:bg-gray-50 rounded cursor-pointer group">
                    <div class="flex items-center overflow-hidden">
                        ...
                        <span class="text-xs text-gray-600 truncate font-medium">Perpol No. 4 Th 2020 (Pam Swakarsa)</span>
                    </div>
                ...
                <li class="flex items-center justify-between p-2 hover:bg-gray-50 rounded cursor-pointer group">
                    <div class="flex items-center overflow-hidden">
                        ...
                        <span class="text-xs text-gray-600 truncate font-medium">Formulir Pendaftaran BUJP</span>
                    </div>
